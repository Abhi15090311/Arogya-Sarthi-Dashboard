             ...
             <div className="grid grid-col-7 grid-flow-col mt-[1rem]">
              ...
              <div className="flex flex-row ml-[5rem] mt-[-2rem]">
                ...
                <div className=" bg-slate-50 h-[3rem] w-[6rem] ml-[3rem] rounded-[0.3rem]">
                  ...
                  <div className="flex flex-row">
                  <button className="bg-slate-100 h-[1.5`rem] w-[2.5rem] ml-[0.4rem] mt-[0.1rem] rounded-[0.3rem] text-base border border-white text-yellow-300 hover:pointer hover:bg-green-400 text-[0.4rem]">5 Accepted</button>
                  <button className="bg-slate-100 h-[1.5`rem] w-[2.5rem] ml-[0.4rem] mt-[0.1rem] rounded-[0.3rem] text-base border border-white text-yellow-300 hover:pointer hover:bg-green-400 text-[0.4rem]">9 Pending</button>
                  </div>
                </div>
                </div>
                <div className=" bg-slate-50 mt-[2rem] h-[6rem] w-[10rem] border-slate-300 border-[0.05rem]">
